(function($){
    ...
    var tpl = require('view/overComment_tpl');

    overComment.list = function(page){
    	var self=this;    
        ...
        $.ajax({
            ...
            var html = tpl.overComment(data.data.commentList);
  	...
  	overComment.search = function(){
	    var self = this;
	    self.list(1);
    }

    overComment.view = function(){
